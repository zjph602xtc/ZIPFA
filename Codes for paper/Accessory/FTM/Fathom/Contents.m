%  
% Path ->  /Users/djones/Dropbox/djones/work/mWork/Fathom
% 
%   cl                  - same as clc
...
%   f_bootDis           - bootstrap resampling with replacement of a symmetric distance matrix
%   f_boxPlot           - create customized box plot
...
%   f_clarkEvans        - Clark-Evans index of spatial randomness
...
%   f_eucN              - pair-wise Euclidean distances normalized to 0-1 scale
...
%   f_grpPrctile        - returns the percentiles of X (column-wise) separately for groups
...
%   f_grpSum            - returns the sum of X (column-wise) separately for groups
...
%   f_indVal            - species indicator values analysis (IndVal)
%   f_interaction       - create an interaction term between factor A and factor B
...
%   f_isWhole           - determine whether X is a whole number
...
%   f_npDisp            - homogeneity of multivariate dispersion (= NP-DISP, PERMDISP)
...
%   f_pca_importance    - descriptor variable importance measures for a PCA
...
%   f_pcoa_2            - Principal Coordinates Analysis (PCoA)
...
%   f_permanova         - one-way (modified) permutational MANOVA
%   f_permanovaPW       - pair-wise tests based on (modified) PERMANOVA
...
%   f_rdaPlot2          - ordination distance biplot for a Redundancy Analysis (RDA)
%   f_rdaStepwise       - stepwise selection of explanatory variables in RDA based on F-stat
%   f_rdaStepwise_FIX   - stepwise selection of explanatory variables in RDA based on F-stat
%   f_rda_02            - Redundancy Analysis (RDA)
...
%   f_simper            - similarity percentages (SIMPER) & variable importance
...
%   f_venn              - plot 2- or 3- circle area-proportional Venn diagram
...
%   f_vpa               - variation partitioning analysis
%   f_vpaDB             - distance-based variation partitioning analysis
...
%   f_wtRndSamp         - get index to create a weighted random sample
