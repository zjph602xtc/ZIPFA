function H = f_rdaPlot2(result,Y,wascores,scale,offset,yLabels,xLabels,fmt,iter,sLabels)
...
if (wascores>0) % plot Y's WA scores (McCune, 1997):
   ...
   for j = 1:ncY
      f_arrow2([0 0],[biplotY(j,1) biplotY(j,2)],'Length',0,'BaseAngle',20,'EdgeColor',f_rgb(2),FaceColor',f_rgb(2));
...
for j = 1:size(biplotX,1)
   H_arrow = f_arrow2([0 0],[biplotX(j,1) biplotX(j,2)],'Length',0,'BaseAngle',20,'EdgeColor','r','FaceColor','r');
