...
%           'get' command
% Jun-2015: updated the way contour headers are removed so it is compatible with
%           the new version of M_Map Toolbox
...
cs        = cs';
idx       = find(abs(cs)>=360); % eliminate contour headers
cs(idx,:) = NaN;
